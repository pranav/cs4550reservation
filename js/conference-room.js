...
function add_form_conference_rooms(){
  $('.conference-room').each(function(k,v){
    $(this).append('<h3>Reserve <small><a class="schedule" href="#">See schedule</a></small></h3><form class="form-inline conference-form" action=process.php method=POST><input class="date span2" type="date" name="date" placeholder="Date (YYYY-MM-DD)"> <input class="btn btn-primary" type="submit" value="Submit"></form><div class="schedule-container"></div>');
  });
}
